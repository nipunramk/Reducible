...
from manimlib.utils.space_ops import phi_of_vector
...
class TipableVMobject(VMobject):
    ...
    def position_tip(self, tip, at_start=False):
        ...
        # Reducible specific change for handling arrows in 3D Scene
...
class Circle(Arc):
    ...
    def __init__(self, start_angle=0, TAU=TAU, **kwargs):
...
class RegularPolygonDepreciated(Polygon):
    CONFIG = {
        "start_angle": 0
    }
